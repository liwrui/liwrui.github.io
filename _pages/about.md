...
5. **Wenrui Li**, Zhe Yang, Wei Han, Hengyu Man, Xingtao Wang and Xiaopeng Fan. "Hyperbolic-constraint Point Cloud Reconstruction from Single RGB-D Images", in AAAI, 2024.
6. **Wenrui Li**, Wei Han, Yandu Chen, Yeyu Chai, Yidan Lu, Xingtao Wang and Xiaopeng Fan. "Riemann-based Multi-scale Attention Reasoning Network for Text-3D Retrieval", in AAAI, 2024.
...
15. Jisheng Chu, **Wenrui Li**, Xingtao Wang, Ning Kanglin, Yidan Lu and Xiaopeng Fan. "Riemann-based Multi-scale Attention Reasoning Network for Text-3D Retrieval", in AAAI, 2024.
